...
// Uint32ToBytes converts a uint32 to 4 bytes in big-endian
...
// Uint64ToBytes converts a uint64 to 8 bytes in big-endian
...
// BytesToUint64 converts 8 bytes to uint64 in big-endian
